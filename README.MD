...
On this moment CloudCross supports working with Yandex Disk, Google Drive, Dropbox and Cloud Mail.ru.
...
На данный момент, пока, поддерживается работа с Яндекс.Диск, Google Drive, Dropbox и Облако Mail.ru.
